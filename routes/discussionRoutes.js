...
router.get("/get-hashtags/:discussionId", DiscussionController.getDiscussionHashtags);
...
router.get("/get-answers-user-ud/:discussionId", authMiddleware, DiscussionController.getAnswersUserUD);
